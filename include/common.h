...
enum class BC2D { PERIODIC, NEUMANN, DIRICHLET, AXISYM, WALL, INLET, OUTLET, PRESSURE, LSFREE, CUSTOM };
enum class BC3D { PERIODIC, NEUMANN, DIRICHLET, WALL, INLET, OUTLET, PRESSURE, LSFREE, CUSTOM };
